...
@OnlyIn(Dist.CLIENT)
public class RendererPortalDockControllerSurface4 implements BlockEntityRenderer<BlockEntityPortalDockControllerSurface4> {
	...
	public RendererPortalDockControllerSurface4(BlockEntityRendererProvider.Context contextIn) {
		this.context = contextIn;
	}	

	@Override
	public void render(BlockEntityPortalDockControllerSurface4 entityIn, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
		...
		if (level.getBlockState(entityPos).getBlock() instanceof BlockPortalDockControllerSurface4) {
			
			Direction facing = level.getBlockState(entityPos).getValue(BlockPortalDockControllerSurface4.FACING);
