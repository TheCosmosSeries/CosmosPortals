...
public final class ScreenConfigurationCommon extends Screen {
	...
	public ScreenConfigurationCommon(ModContainer container, Screen parent) {
	...
	protected void init() {
		this.OPTIONS_ROW_LIST = new CosmosOptionsList( 
			...
			OPTIONS_LIST_ITEM_HEIGHT, OPTIONS_LIST_BUTTON_HEIGHT, OPTIONS_LIST_WIDTH, new CosmosOptions(Minecraft.getInstance(), new File(this.minecraft.gameDirectory.getAbsolutePath() + "/cosmosportals"))
		);
	...
	public void render(GuiGraphics graphics, int mouseX, int mouseY, float ticks) {
        ...
        for (Renderable renderable : this.renderables) {
            renderable.render(graphics, mouseX, mouseY, ticks);
        }
